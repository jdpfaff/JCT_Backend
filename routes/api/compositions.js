...
// @route    PUT api/compositions/edit/:id
// @desc     Edit certain datafields of a given composition
// @access   Private
...
router.put('/edit/:id', async (req, res) => {
  try {
    ...
    // Both title and description are trimmed as to not allow blank composition names
...
// @desc     Obtain a list of all private compositions
// @access   Public
...
// @route    POST api/compositions/title
// @desc     filter compositions by title
// @access   Public
...
// @route    POST api/compositions/composer
// @desc     filter compositions by composer
// @access   Public
...
// @route    POST api/compositions/performer
// @desc     Filters compositions by performer name.
// @access   Public
...
// @route    POST api/compositions/tags
// @desc     filter compositions by a given tag
// @access   Public
...
// @route    GET api/compositions/generate/:id
// @desc     Generates an ID for a new composition of a specific user.
// @access   Server
...
// @route    GET api/compositions/newest/:id
// @desc     Retrieves the Id of the lates composition of a specific user. 
	     Used to call edit/:id after a composition id has been made
// @access   Server
...
// @route    GET api/compositions/usercompositions
// @desc     Generates an ID for a new composition of a specific user.
// @access   Private
...
// @desc     Get's the data for a given database
// @access   Public
...
// @route    GET api/compositions/user/:id
// @desc     Obtains a list of a user's compositions, currently not being used.
// @access   Public
